  ...
  return (
    <section id="how-we-build" className="py-24 lg:py-32 px-6 relative">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <StaggerGrid className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
          {steps.map((step) => (
            <StaggerCard key={step.number}>
              <div className="bg-background p-8 lg:p-10 group hover:bg-surface-1 transition-colors duration-300 h-full">
