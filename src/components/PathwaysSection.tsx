        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {pathways.map((p) => (
              <div
                key={p.title}
                className="relative p-8 rounded-sm glow-border glow-border-hover bg-background group"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-px bg-border">
            {audiences.map((a) => (
              <div
                key={a.group}
                className="bg-background p-10 group hover:bg-surface-1 transition-colors duration-300"
              >
